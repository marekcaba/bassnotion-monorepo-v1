...
const threeLayerNotes = [
  ...
  'C5', 'B4', 'A#4', 'G#4', 'G4', 'F4', 'D4', 'C3'
];

// Notes that have 4 velocity layers (v1, v2, v3, v4)
const fourLayerNotes = [
  'A4', 'F#4', 'E4', 'C#4', 'C4', 'B3', 'A#3', 'G#3', 'G3', 'F#3', 'E3', 'D#3',
  'F#2', 'F2', 'E2', 'D#2', 'D2', 'C#2', 'A#1', 'A1', 'D#1', 'D1', 'E1', 'F1',
  'G#1', 'A1', 'A#1', 'C#1', 'B0'
];

// Notes that have 5 velocity layers (v1, v2, v3, v4, v5)
const fiveLayerNotes = [
  'D#4', 'A3', 'F3', 'D3', 'C#3', 'B2', 'A#2', 'A2', 'G#2', 'G2', 'C2', 'B1',
  'G#1', 'G1', 'F#1', 'C1', 'A#0', 'A0'
];
...
const perNoteVelocityRanges: Record<string, Array<{ min: number; max: number; layer: string }>> = {};
...
const config = {
  ...
  description: "Classic Wurlitzer 200A electric piano with per-note velocity layers (OGG format)",

  storage: {
    baseUrl: "https://iuuplfrktnzsbzibpfjm.supabase.co/storage/v1/object/public/audio-samples",
