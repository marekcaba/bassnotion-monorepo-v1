...
import { useTransitionPreHeat, useViewTransitionRouter } from '@/lib/hooks/use-view-transition-router';
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border bg-card p-6">
        ...
        <p className="text-muted-foreground mb-4">
          This app uses smooth page transitions with performance monitoring and pre-heating.
        </p>
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <span className={isPreHeated() ? "text-green-500" : "text-yellow-500"}>
              {isPreHeated() ? "✅" : "🔥"}
            </span>
            <span>
              Transition Pre-heating {isPreHeated() ? "(Complete)" : "(In Progress)"}
            </span>
          </div>
        </div>
      ...
      <div className="rounded-lg border bg-card p-6">
        ...
        <p className="text-muted-foreground mb-4">
          The transition system pre-heats automatically for smooth first impressions.
        </p>
        <div className="space-y-2 text-sm">
          ...
          <div className="flex items-start gap-2">
            <span className="text-blue-500">•</span>
            <span>
              <strong>CSS pre-injection:</strong> Styles ready before first transition
            </span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-blue-500">•</span>
            <span>
              <strong>Smart caching:</strong> Maintains performance for subsequent transitions
            </span>
          </div>
        </div>
      </div>
