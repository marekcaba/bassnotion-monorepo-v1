...
vi.mock('../../../../../services/plugins/BassInstrumentProcessor.js', () => {
  return {
...
describe('BassInstrument', () => {
  ...
  beforeEach(() => {
    ...
    bassInstrument = new BassInstrument(config);
  });
  ...
  describe('Construction', () => {
    ...
    it('should set default values for optional parameters', () => {
      ...
      const minimalBass = new BassInstrument(minimalConfig);
  ...
  describe('Note Triggering', () => {
    ...
    it('should not trigger when not initialized', () => {
      const uninitializedBass = new BassInstrument(config);
      const event = {
        audioTime: 0.5,
        timestamp: Date.now(),
        velocity: 0.8,
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Bass Test Bass not initialized');
  ...
  describe('Direct Note Playing', () => {
    ...
    it('should not play when not initialized', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Bass not initialized');
      consoleSpy.mockRestore();
    });
  });
  ...
  describe('Parameter Updates', () => {
    ...
    it('should update parameters', () => {
      ...
      const loadSamplesSpy = vi.spyOn(bassInstrument as any, 'loadSamples').mockImplementation(() => {});
