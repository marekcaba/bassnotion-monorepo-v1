 ...
 *
 * NOTE: This file was moved from widgets/utils/ to playback/modules/instruments/
 * as part of circular dependency cleanup. The singleton manages WAM plugins
 * which are a playback domain concern.
 */

import { WamKeyboard } from './adapters/wam/WamKeyboard.js';
import { getLogger } from '@/utils/logger';
import { GlobalSampleCache } from '../storage/index.js';
