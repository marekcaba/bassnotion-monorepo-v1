...
describe('SampleCache', () => {
  ...
  describe('eviction', () => {
    it('should evict when max size exceeded', () => {
      ...
      cache.set('sample1', new ArrayBuffer(1000), { ...testMetadata, sampleId: 'sample1' });
      cache.set('sample2', new ArrayBuffer(1000), { ...testMetadata, sampleId: 'sample2' });
      cache.set('sample3', new ArrayBuffer(1000), { ...testMetadata, sampleId: 'sample3' });
      cache.set('sample4', new ArrayBuffer(1000), { ...testMetadata, sampleId: 'sample4' });
  ...
  describe('bulk operations', () => {
    it('should preload multiple samples', async () => {
      const samples = [
        { sampleId: 'sample1', data: new ArrayBuffer(1024), metadata: { ...testMetadata, sampleId: 'sample1' } },
        { sampleId: 'sample2', data: new ArrayBuffer(1024), metadata: { ...testMetadata, sampleId: 'sample2' } },
        { sampleId: 'sample3', data: new ArrayBuffer(1024), metadata: { ...testMetadata, sampleId: 'sample3' } },
      ];
