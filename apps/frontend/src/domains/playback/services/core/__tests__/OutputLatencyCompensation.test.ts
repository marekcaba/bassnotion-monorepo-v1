...
import { OutputLatencyCompensation, LatencySource } from '../OutputLatencyCompensation.js';
...
describe('OutputLatencyCompensation', () => {
  ...
  describe('audio processing', () => {
    ...
    it('should bypass compensation when disabled', () => {
      ...
      compensation.processWithCompensation('track-1', inputBuffer, outputBuffer);
  ...
  describe('state management', () => {
    ...
    it('should toggle zero-latency monitoring', () => {
      ...
      expect(compensation.getTrackCompensationDelay('track-1')).toBe(0);
      expect(compensation.getTrackCompensationDelay('track-2')).toBeGreaterThan(0);
    });
  });
