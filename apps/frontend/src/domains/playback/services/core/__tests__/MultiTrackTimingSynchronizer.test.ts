...
import type { MusicalPosition, TransportPosition } from '../UnifiedTransport.js';
...
describe('MultiTrackTimingSynchronizer', () => {
  ...
  describe('event scheduling', () => {
    ...
    it('should throw error for unregistered track', () => {
      ...
      expect(() => {
        synchronizer.scheduleTrackEvent('unknown-track', callback, musicalPosition);
  ...
  describe('track isolation', () => {
    ...
    it('should isolate track after error threshold', () => {
      ...
      expect(mockEventBus.emit).toHaveBeenCalledWith('timing:trackIsolated', expect.any(Object));
    });
