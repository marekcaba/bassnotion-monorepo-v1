  ...
  describe('analyzeExercise', () => {
    ...
    it('should estimate memory requirements correctly', async () => {
      const exercise = Exercise.create({
        ...
        key: 'C',
        notes: [
          { id: '1', string: 1, fret: 5, note: 'D2', color: 'red', duration: 'quarter', position: { measure: 1, beat: 1, subdivision: 0 } },
          { id: '2', string: 1, fret: 7, note: 'E2', color: 'blue', duration: 'quarter', position: { measure: 1, beat: 2, subdivision: 0 } },
          { id: '3', string: 2, fret: 5, note: 'A2', color: 'green', duration: 'quarter', position: { measure: 1, beat: 3, subdivision: 0 } },
        ],
        tags: [],
        isActive: true,
      });
