...
describe('ServiceErrorBoundary', () => {
  ...
  describe('Basic Error Protection', () => {
    ...
    it('should catch and record errors', async () => {
      ...
      await expect(
        errorBoundary.protect('test-service', 'operation', () =>
          mockService.performOperation(),
        ),
    ...
    it('should emit error event on failure', async () => {
      ...
      try {
        await errorBoundary.protect('test-service', 'operation', () =>
          mockService.performOperation(),
        );
      } catch (error) {
        // Expected
  ...
  describe('Default Recovery Strategies', () => {
    it('should retry on network errors', async () => {
      ...
      const retryStrategy = (errorBoundary as any)
        .getDefaultStrategies()
        .find((s: RecoveryStrategy) => s.name === 'retry-transient');
  ...
  describe('Manual Service Management', () => {
    ...
    it('should clear all error history', async () => {
      ...
      try {
        await errorBoundary.protect('service1', 'operation', () =>
          mockService.performOperation(),
        );
      } catch (error) {
        // Expected
      ...
      try {
        await errorBoundary.protect('service2', 'operation', () =>
          mockService.performOperation(),
        );
      } catch (error) {
        // Expected
