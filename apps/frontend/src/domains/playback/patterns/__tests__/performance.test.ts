...
describe('Performance Tests', () => {
  ...
  describe('Pattern Overhead', () => {
    it('should have minimal overhead for circuit breaker', async () => {
      ...
      console.log(
        `Circuit Breaker overhead: ${overhead.toFixed(3)}ms per operation`,
      );
    ...
    it('should have minimal overhead for error boundary', async () => {
      ...
      for (let i = 0; i < iterations; i++) {
        await errorBoundary.protect('test', 'performOperation', () =>
          mockService.performOperation(0),
        );
      }
      ...
      console.log(
        `Error Boundary overhead: ${overhead.toFixed(3)}ms per operation`,
      );
    ...
    it('should have acceptable overhead for combined patterns', async () => {
      ...
      console.log(
        `Combined patterns overhead: ${overhead.toFixed(3)}ms per operation`,
      );
  ...
  describe('Command Queue Performance', () => {
    it('should process commands efficiently', async () => {
      ...
      console.log(
        `Command execution time for ${commandCount} commands: ${executionTime}ms`,
      );
      console.log(
        `Command throughput: ${throughput.toFixed(2)} commands/second`,
      );
  ...
  describe('Memory Usage', () => {
    it('should not leak memory in event bus', async () => {
      ...
      console.log(
        `Growth per iteration: ${growthPerIteration.toFixed(2)} bytes`,
      );
    ...
    it('should properly clean up disposed services', async () => {
      ...
      console.log(
        `Memory before dispose: ${(beforeDispose / 1024 / 1024).toFixed(2)}MB`,
      );
      console.log(
        `Memory after dispose: ${(afterDispose / 1024 / 1024).toFixed(2)}MB`,
      );
  ...
  describe('Scalability', () => {
    it('should handle many services efficiently', async () => {
      ...
      console.log(
        `Registration time for ${serviceCount} services: ${registerTime}ms`,
      );
  ...
  describe('Performance Monitoring', () => {
    it('should track metrics with minimal overhead', async () => {
      ...
      console.log(
        `Performance monitoring overhead: ${overhead.toFixed(3)}ms per operation`,
      );
