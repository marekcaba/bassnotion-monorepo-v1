...
export const ExerciseDescriptionCard = React.memo(
  function ExerciseDescriptionCard({
    selectedExercise,
  }: ExerciseDescriptionCardProps) {
    const details = useMemo(() => {
      if (!selectedExercise) return null;
      const difficulty =
        safeString(selectedExercise.difficulty).toLowerCase() || 'beginner';
      const colors = difficultyColors[difficulty] || difficultyColors.beginner;
      return {
        title: safeString(selectedExercise.title) || 'Untitled',
        description:
          safeString(selectedExercise.description) ||
