...
export function TimingDebugWindow({ isVisible, onClose }: TimingDebugWindowProps) {
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <div className="text-slate-300">
            ...
            <div className={`font-bold ${stats.overall.syncScore > 80 ? 'text-green-400' : stats.overall.syncScore > 60 ? 'text-yellow-400' : 'text-red-400'}`}>
        ...
        <div>
          ...
          <div className="text-slate-300">
            ...
            <div className={`${stats.drums.syncScore > 80 ? 'text-green-400' : stats.drums.syncScore > 60 ? 'text-yellow-400' : 'text-red-400'}`}>
        ...
        <div>
          ...
          <div className="text-slate-300">
            ...
            <div className={`${stats.metronome.syncScore > 80 ? 'text-green-400' : stats.metronome.syncScore > 60 ? 'text-yellow-400' : 'text-red-400'}`}>
        ...
        {stats.drums.totalBeats > 0 && stats.metronome.totalBeats > 0 && (
          <div>
            ...
            <div className="text-slate-300">
              <div>Timing Diff: {comparison.averageDifference.toFixed(1)}ms</div>
              <div className={`${comparison.correlation > 80 ? 'text-green-400' : comparison.correlation > 60 ? 'text-yellow-400' : 'text-red-400'}`}>
