...
function SheetPlayerCardContent({ syncProps }: SheetPlayerCardContentProps) {
  ...
  }, [syncProps.currentTime, currentPosition, exerciseNotes.length]);
  ...
  const processNotesForDisplay = (
    ...
    console.log('Found measures:', measureNumbers);
    console.log('Measure map:', Array.from(measureMap.entries()));
