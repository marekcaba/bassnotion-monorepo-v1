    ...
    const actualLogs = [
      {
        time: 0,
        message:
          'WidgetSyncService: Received PLAY event from test-transport-page',
      },
      {
        time: 100,
        message:
      ...
      {
        time: 100,
        message: 'useWidgetSync[harmony-widget]: Received PLAY event',
      },
      {
        time: 100,
        message: 'useWidgetSync[drummer-widget]: Received PLAY event',
      },
