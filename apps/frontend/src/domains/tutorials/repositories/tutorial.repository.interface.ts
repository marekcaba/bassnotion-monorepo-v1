...
export interface ITutorialRepository {
  ...
  findAll(options?: PaginationOptions): Promise<Result<PaginatedResult<Tutorial>>>;
  ...
  findPublished(options?: PaginationOptions): Promise<Result<PaginatedResult<Tutorial>>>;
  findRelated(tutorialId: TutorialId, limit?: number): Promise<Result<Tutorial[]>>;
