...
import { correlation, createCorrelatedAction, WithCorrelation } from './correlationMiddleware';
 ...
 */
export const useUserUIStoreWithCorrelation = create<WithCorrelation<UserUIState>>()(
  devtools(
    correlation(
      (set, get) => ({
        // Initial state
        ...
        setSelectedTab: createCorrelatedAction(
          'UserUIStore',
          'setSelectedTab',
          (get, set, correlationId, tab: 'profile' | 'preferences' | 'security') => {
            set({ selectedTab: tab });
          }
        )(get, set),
        ...
        setProfileFormData: createCorrelatedAction(
          'UserUIStore',
          'setProfileFormData',
          (get, set, correlationId, data: { displayName: string; bio: string }) => {
