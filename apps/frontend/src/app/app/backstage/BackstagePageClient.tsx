...
/**
 * The backstage CLIENT tree. Split out of page.tsx (now a server component) so the server can
 * prefetch the cards' data — see ./page.tsx. The warmTodayRep side-effect (a POST-adjacent mint)
 * stays here in BackstageContent, client-only; the server never triggers it (R11).
 */
export function BackstagePageClient() {
  return (
    <>
