...
/**
 * The store CLIENT tree. Split out of page.tsx (now a server component that prefetches the product
 * list) so useStoreProducts hydrates from the seeded cache — no product spinner. Stays 'use client'
 * because StoreContent uses useSearchParams() (Stripe ?success/?canceled).
 */
