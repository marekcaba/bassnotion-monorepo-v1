...
Sentry.init({
  ...
  // Release tracking
  release: process.env.NEXT_PUBLIC_SENTRY_RELEASE || 'bassnotion-frontend@unknown',
  ...
  beforeSend(event, hint) {
    ...
    if (process.env.NODE_ENV === 'development' && error && error.toString().includes('NetworkError')) {
      return null;
    }
