...
test.describe('DAW Integration E2E Tests', () => {
  ...
  test('should initialize DAW components after clicking play', async ({
    page,
  }) => {
    ...
    const transportBadge = page
      .locator('div:has(> h3:has-text("Transport"))')
      .locator('span')
      .first();
  ...
  test('should create and play test patterns', async ({ page }) => {
    ...
    const activeRegionsText = await page
      .locator('text=Active Regions:')
      .first();
  ...
  test('should test audio output', async ({ page }) => {
    ...
    const audioTestButton = page.locator(
      'button:has-text("Test Audio Output")',
    );
  ...
  test('should display track information', async ({ page }) => {
    ...
    const metronomeSection = page
      .locator('h3:has-text("Metronome Track")')
      .locator('..');
