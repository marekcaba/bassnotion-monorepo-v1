...
When clicking the play button, the console was flooded with millions of "\_\_globalCoreServices not available on window" messages, causing the browser to freeze.
