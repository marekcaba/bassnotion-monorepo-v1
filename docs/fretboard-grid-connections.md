...
{
  condition && isHighlighted && <div className="bg-green-500 opacity-100" />;
}

// ❌ WRONG - Shows white grid that changes
{
  condition && <div className={isHighlighted ? 'bg-green-500' : 'bg-white'} />;
}
```
