...
var __decorateClass$8 = (decorators, target, key, kind) => {
  var result =
    kind > 1 ? void 0 : kind ? __getOwnPropDesc$8(target, key) : target;
...
__decorateClass$8([Get()], AppController.prototype, 'getHello', 1);
AppController = __decorateClass$8([Controller()], AppController);
var __getOwnPropDesc$7 = Object.getOwnPropertyDescriptor;
var __decorateClass$7 = (decorators, target, key, kind) => {
  var result =
    kind > 1 ? void 0 : kind ? __getOwnPropDesc$7(target, key) : target;
  for (var i = decorators.length - 1, decorator; i >= 0; i--)
...
AppService = __decorateClass$7([Injectable()], AppService);
var __getOwnPropDesc$6 = Object.getOwnPropertyDescriptor;
var __decorateClass$6 = (decorators, target, key, kind) => {
  var result =
    kind > 1 ? void 0 : kind ? __getOwnPropDesc$6(target, key) : target;
  for (var i = decorators.length - 1, decorator; i >= 0; i--)
    if ((decorator = decorators[i])) result = decorator(result) || result;
  return result;
};
...
DatabaseService = __decorateClass$6([Injectable()], DatabaseService);
var __getOwnPropDesc$5 = Object.getOwnPropertyDescriptor;
var __decorateClass$5 = (decorators, target, key, kind) => {
  var result =
    kind > 1 ? void 0 : kind ? __getOwnPropDesc$5(target, key) : target;
  for (var i = decorators.length - 1, decorator; i >= 0; i--)
    if ((decorator = decorators[i])) result = decorator(result) || result;
  return result;
};
...
var __decorateClass$4 = (decorators, target, key, kind) => {
  var result =
    kind > 1 ? void 0 : kind ? __getOwnPropDesc$4(target, key) : target;
  for (var i = decorators.length - 1, decorator; i >= 0; i--)
    if ((decorator = decorators[i])) result = decorator(result) || result;
  return result;
};
...
AuthGuard = __decorateClass$4([Injectable()], AuthGuard);
var __defProp = Object.defineProperty;
var __getOwnPropDesc$3 = Object.getOwnPropertyDescriptor;
var __decorateClass$3 = (decorators, target, key, kind) => {
  var result =
    kind > 1 ? void 0 : kind ? __getOwnPropDesc$3(target, key) : target;
  for (var i = decorators.length - 1, decorator; i >= 0; i--)
    if ((decorator = decorators[i]))
      result =
        (kind ? decorator(target, key, result) : decorator(result)) || result;
...
__decorateClass$3(
  [Post('signup'), HttpCode(HttpStatus.CREATED), __decorateParam(0, Body())],
  AuthController.prototype,
  'signup',
  1,
);
__decorateClass$3(
  [Post('signin'), HttpCode(HttpStatus.OK), __decorateParam(0, Body())],
  AuthController.prototype,
  'signin',
  1,
);
__decorateClass$3(
  [Get('me'), UseGuards(AuthGuard), HttpCode(HttpStatus.OK)],
  AuthController.prototype,
  'getCurrentUser',
  1,
);
AuthController = __decorateClass$3([Controller('auth')], AuthController);
  ...
  normalizeError(error) {
    if (error instanceof Error) {
      return {
        ...
        code:
          error instanceof AuthError ? String(error.status) : 'UNKNOWN_ERROR',
      };
    }
    if (
      error &&
...
AuthService = __decorateClass$2([Injectable()], AuthService);
