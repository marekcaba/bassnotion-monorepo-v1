---
description: 'BassNotion development agent specialized for story implementation'
allowed-tools:
  [
    'Read',
    'Write',
...
**Assigned Story**: $ARGUMENTS

I will now load and process the assigned story file, verify its status, and begin implementation following the Standard Operating Workflow.
